...
object FileUtilsTests {
    ...
    fun runTests(context: Context, testRootDirectoryPath: String) {
        try {
            ...
            Logger.showToast(context, e.message?.replace(Regex("(?s)\nFull Error:\n.*"), ""), true)
        }
    }
    ...
    private fun runTestsInner(testRootDirectoryPath: String) {
        ...
        val dir1__sub_dir2_label = "dir1/sub_dir2"
        val dir1__sub_dir2_path = "$dir1_path/sub_dir2"

        val dir1__sub_dir3_label = "dir1/sub_dir3"
        val dir1__sub_dir3_path = "$dir1_path/sub_dir3"

        val dir1__sub_dir3__sub_reg1_label = "dir1/sub_dir3/sub_reg1"
        val dir1__sub_dir3__sub_reg1_path = "$dir1__sub_dir3_path/sub_reg1"
        ...
        if (File(path).canonicalPath != dir2_path)
        ...
        // Check if dir2 directory file still exists after deletion of dir1/sub_sym2
        ...
        // Check if dir2 directory file and dir2/sub_reg1 regular file still exist
        label = dir2_label; path = dir2_path
        if (!FileUtils.directoryFileExists(path, false))
        ...
        val ignoredSubFilePaths = listOf(dir1__sub_dir2_path, dir1__sub_dir3__sub_reg1_path)
    ...
    private fun equalsRegardingNull(expected: String?, actual: String?): Boolean {
        return if (expected == null) actual == null else expected == actual
    }
