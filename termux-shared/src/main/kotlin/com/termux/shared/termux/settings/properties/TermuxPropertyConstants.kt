...
object TermuxPropertyConstants {
    ...
    @Deprecated("Use KEY_NIGHT_MODE instead")
    ...
    @JvmField
    val MAP_BELL_BEHAVIOUR: ImmutableBiMap<String, Int> = ImmutableBiMap.Builder<String, Int>()
    ...
    @JvmField val IVALUE_TERMINAL_CURSOR_BLINK_RATE_MIN = TerminalView.TERMINAL_CURSOR_BLINK_RATE_MIN
    @JvmField val IVALUE_TERMINAL_CURSOR_BLINK_RATE_MAX = TerminalView.TERMINAL_CURSOR_BLINK_RATE_MAX
    ...
    @JvmField val IVALUE_TERMINAL_CURSOR_STYLE_BLOCK = TerminalEmulator.TERMINAL_CURSOR_STYLE_BLOCK
    @JvmField val IVALUE_TERMINAL_CURSOR_STYLE_UNDERLINE = TerminalEmulator.TERMINAL_CURSOR_STYLE_UNDERLINE
    @JvmField val IVALUE_TERMINAL_CURSOR_STYLE_BAR = TerminalEmulator.TERMINAL_CURSOR_STYLE_BAR
    @JvmField val DEFAULT_IVALUE_TERMINAL_CURSOR_STYLE = TerminalEmulator.DEFAULT_TERMINAL_CURSOR_STYLE

    /** Defines the bidirectional map for terminal cursor styles and their internal values */
    @JvmField
    val MAP_TERMINAL_CURSOR_STYLE: ImmutableBiMap<String, Int> = ImmutableBiMap.Builder<String, Int>()
    ...
    @JvmField val IVALUE_TERMINAL_TRANSCRIPT_ROWS_MIN = TerminalEmulator.TERMINAL_TRANSCRIPT_ROWS_MIN
    @JvmField val IVALUE_TERMINAL_TRANSCRIPT_ROWS_MAX = TerminalEmulator.TERMINAL_TRANSCRIPT_ROWS_MAX
    @JvmField val DEFAULT_IVALUE_TERMINAL_TRANSCRIPT_ROWS = TerminalEmulator.DEFAULT_TERMINAL_TRANSCRIPT_ROWS
    ...
    @JvmField
    val MAP_SESSION_SHORTCUTS: ImmutableBiMap<String, Int> = ImmutableBiMap.Builder<String, Int>()
    ...
    @JvmField
    val MAP_BACK_KEY_BEHAVIOUR: ImmutableBiMap<String, String> = ImmutableBiMap.Builder<String, String>()
    ...
    @JvmField val DEFAULT_IVALUE_DEFAULT_WORKING_DIRECTORY: String = TermuxConstants.TERMUX_HOME_DIR_PATH


    /** Defines the key for extra keys */
    const val KEY_EXTRA_KEYS = "extra-keys"
    const val DEFAULT_IVALUE_EXTRA_KEYS = "[['ESC','/',{key: '-', popup: '|'},'HOME','UP','END','PGUP'], ['TAB','CTRL','ALT','LEFT','DOWN','RIGHT','PGDN']]"
    ...
    @JvmField val IVALUE_NIGHT_MODE_TRUE: String = NightMode.TRUE.name
    @JvmField val IVALUE_NIGHT_MODE_FALSE: String = NightMode.FALSE.name
    @JvmField val IVALUE_NIGHT_MODE_SYSTEM: String = NightMode.SYSTEM.name
    @JvmField val DEFAULT_IVALUE_NIGHT_MODE: String = IVALUE_NIGHT_MODE_SYSTEM

    /** Defines the bidirectional map for [NightMode] values and their internal values */
    @JvmField
    val MAP_NIGHT_MODE: ImmutableBiMap<String, String> = ImmutableBiMap.Builder<String, String>()
    ...
    @JvmField
    val MAP_SOFT_KEYBOARD_TOGGLE_BEHAVIOUR: ImmutableBiMap<String, String> = ImmutableBiMap.Builder<String, String>()
    ...
    @JvmField
    val MAP_VOLUME_KEYS_BEHAVIOUR: ImmutableBiMap<String, String> = ImmutableBiMap.Builder<String, String>()
     ...
     * Setting this to `null` will make [com.termux.shared.settings.properties.SharedProperties] throw an exception.
     */
    @JvmField
    val TERMUX_APP_PROPERTIES_LIST: Set<String> = hashSetOf(
        /* boolean */
     ...
     */
    @JvmField
    val TERMUX_DEFAULT_FALSE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST: Set<String> = hashSetOf(
        KEY_DISABLE_FILE_SHARE_RECEIVER,
        KEY_DISABLE_FILE_VIEW_RECEIVER,
        KEY_DISABLE_HARDWARE_KEYBOARD_SHORTCUTS,
        KEY_DISABLE_TERMINAL_SESSION_CHANGE_TOAST,
     ...
     */
    @JvmField
    val TERMUX_DEFAULT_TRUE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST: Set<String> = hashSetOf(
        KEY_EXTRA_KEYS_TEXT_ALL_CAPS,
        KEY_RUN_TERMUX_AM_SOCKET_SERVER
    )
     ...
     */
    @JvmField
    val TERMUX_DEFAULT_INVERETED_FALSE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST: Set<String> = hashSetOf()
     ...
     */
    @JvmField
    val TERMUX_DEFAULT_INVERETED_TRUE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST: Set<String> = hashSetOf()
}
